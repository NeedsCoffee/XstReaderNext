...
That modernization was the defining change in version `2.0`. Version `2.1.2` adds follow-on parser/spec alignment, OST compatibility work, and PST CRC validation fixes.
