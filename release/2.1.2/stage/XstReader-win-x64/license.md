...
This project is distributed under the Microsoft Public License (`MS-PL`).

The following license text governs use of the software in this repository.
...
### (D) Source And Binary Distribution
